         ...
         <section className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-brand-hairline pb-8 sm:pb-12">
           ...
           <div className="flex items-center gap-4">
              <Link
                 ...
                 className="inline-flex items-center justify-center gap-3 rounded-brand bg-brand-canvas px-6 sm:px-8 py-3 sm:py-4 text-[10px] sm:text-[11px] font-bold text-brand-ink shadow-sm border border-brand-hairline hover:bg-brand-canvas-soft transition-all uppercase tracking-normal w-full sm:w-auto"
              >
