       ...
       <main className="max-w-7xl mx-auto p-6 md:p-12 space-y-12">
         ...
         <section className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-brand-hairline pb-12">
           <div className="space-y-2">
             ...
             <p className="text-brand-ink/40 font-bold text-[13px] uppercase tracking-widest">Panel Administrasi Pesona Serpong</p>
           </div>
           
           <div className="flex items-center gap-4">
              <Link
                 href="/dashboard/admin/export"
                 className="inline-flex items-center justify-center gap-3 rounded-brand bg-brand-canvas px-8 py-4 text-[11px] font-bold text-brand-ink shadow-sm border border-brand-hairline hover:bg-brand-canvas-soft transition-all uppercase tracking-widest"
              >
