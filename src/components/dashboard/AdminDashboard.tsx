         ...
         {!currentStatus && (
           <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
             {[
               ...
               { label: 'Darurat', val: stats.urgent, icon: Zap, color: 'red' },
                 ...
                 <div className="flex-1 bg-slate-900 dark:bg-blue-600 p-6 md:p-8 rounded-3xl text-white shadow-xl relative overflow-hidden flex flex-col justify-between">
                    ...
                    <div className="relative z-10 space-y-8">
                       ...
                       <div className="h-2 bg-white/10 rounded-full overflow-hidden">
                          <div className="h-full bg-white rounded-full" style={{ width: `${completionRate}%` }}></div>
                       </div>
                    </div>

                    <Link href="/dashboard/admin/users" className="relative z-10 mt-8 flex items-center justify-between p-4 bg-white/10 hover:bg-white/20 text-white rounded-2xl transition-all group backdrop-blur-md border border-white/10">
                       <span className="text-[9px] font-bold uppercase tracking-widest">Verifikasi {stats.unverifiedUsers} Warga</span>
         ...
         <section className="space-y-6 md:space-y-8 pt-4 md:pt-8">
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 md:gap-6">
               <div className="flex items-center gap-4">
                  <h2 className="text-lg md:text-xl font-bold tracking-tight text-slate-900 dark:text-white uppercase italic">Monitoring Aduan</h2>
               </div>
            ...
            {complaints.length === 0 ? (
               <EmptyState 
                  icon={Inbox}
                  title="Data Kosong"
                  description="Tidak ditemukan laporan yang sesuai kriteria."
