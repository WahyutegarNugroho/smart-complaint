    ...
    return (
      <div className="space-y-4 animate-pulse pt-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[1, 2, 3].map((i) => (
            <div key={i} className="bg-brand-canvas p-5 rounded-xl border border-brand-hairline h-36"></div>
          ))}
        </div>
      </div>
    )
  ...
  if (type === 'detail') {
    return (
      <div className="animate-pulse space-y-4">
        ...
        <div className="bg-brand-canvas rounded-xl border border-brand-hairline p-6 space-y-5">
          <div className="flex gap-3">
            <div className="h-7 w-20 bg-brand-hairline rounded-lg"></div>
            <div className="h-7 w-32 bg-brand-hairline rounded-lg"></div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="h-44 bg-brand-hairline rounded-xl"></div>
            <div className="h-44 bg-brand-hairline rounded-xl"></div>
          </div>
        </div>
      </div>
      ...
      <div className="animate-pulse space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-brand-canvas rounded-xl border border-brand-hairline p-6 h-64"></div>
            <div className="bg-brand-canvas rounded-xl border border-brand-hairline p-6 h-72"></div>
          </div>
        </div>
      </div>
    )
  ...
  return (
    <div className="space-y-6 animate-pulse pt-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <div key={i} className="bg-brand-canvas p-5 rounded-xl border border-brand-hairline h-56"></div>
        ))}
      </div>
    </div>
  )
