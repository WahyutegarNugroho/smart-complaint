...
import { Inbox, Activity, Clock, CheckCircle2 } from 'lucide-react'
...
export default async function PetugasStatsSection() {
  let stats: StatItem[] = []
  
  try {
    const [total, processing, pending, completed] = await Promise.all([
