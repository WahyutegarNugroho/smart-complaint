    ...
    <>
      <form action={deleteComplaint}>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 bg-red-50 dark:bg-red-900/10 text-red-600 dark:text-red-500 py-4 rounded-2xl font-bold text-[10px] uppercase tracking-normal hover:bg-red-600 hover:text-white transition-all shadow-sm active:scale-95"
        >
          <Trash2 size={16} />
