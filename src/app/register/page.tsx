      ...
      <div className="w-full max-w-md py-8 sm:py-12">
        ...
        <div className="card-base p-7 sm:p-12 shadow-xl shadow-brand-ink/5 dark:shadow-black/40 relative overflow-hidden transition-all">
          ...
          <form action={signup} className="space-y-8 relative z-10 text-left">
            ...
            <SubmitButton
              className="w-full h-16 rounded-brand bg-brand-ink text-brand-canvas text-[13px] font-bold uppercase tracking-normal shadow-xl shadow-brand-ink/20 hover:bg-brand-primary hover:text-[#0e0f0c] transition-all active:scale-[0.98] group mt-6"
