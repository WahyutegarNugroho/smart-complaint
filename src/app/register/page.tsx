      ...
      <div className="w-full max-w-md py-8 sm:py-12">
        ...
        <div className="card-base p-7 sm:p-12 shadow-xl shadow-brand-ink/5 dark:shadow-black/40 relative overflow-hidden transition-all">
          ...
          <div className="mb-10 relative z-10 text-left">
            <h1 className="text-4xl font-bold text-brand-ink tracking-tight transition-colors leading-tight">Daftar Akun</h1>
            <p className="text-[11px] font-semibold text-brand-ink/40 mt-3 uppercase tracking-wider transition-colors">Registrasi Identitas Warga</p>
          </div>
          ...
          <form action={signup} className="space-y-8 relative z-10 text-left">
            ...
            <div className="space-y-3">
              <label htmlFor="reg-name" className="text-[10px] font-semibold text-brand-ink/50 uppercase tracking-normal ml-1">Nama Lengkap Sesuai KTP</label>
            ...
            <div className="space-y-3">
              <label htmlFor="reg-email" className="text-[10px] font-semibold text-brand-ink/50 uppercase tracking-normal ml-1">Email Aktif</label>
              <div className="relative group">
            ...
            <div className="space-y-3">
              <label htmlFor="reg-password" className="text-[10px] font-semibold text-brand-ink/50 uppercase tracking-normal ml-1">Kredensial Password</label>
              <div className="relative group">
            ...
            <SubmitButton
              className="w-full h-16 rounded-brand bg-brand-ink dark:bg-brand-primary text-brand-canvas dark:text-[#0e0f0c] text-[13px] font-bold uppercase tracking-normal shadow-xl shadow-brand-ink/20 hover:bg-brand-primary hover:text-[#0e0f0c] transition-all active:scale-[0.98] group mt-6"
          ...
          <div className="mt-12 pt-10 border-t border-brand-hairline text-center relative z-10 transition-colors">
            <p className="text-[11px] text-brand-ink/40 font-bold uppercase tracking-normal">
              ...
              <Link href="/login" className="font-bold text-brand-primary hover:underline block mt-3 text-[13px] tracking-tight">
                MASUK KE DASHBOARD
              </Link>
            </p>
          </div>
