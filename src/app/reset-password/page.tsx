      ...
      <div className="w-full max-w-md py-8 sm:py-12">
        ...
        <div className="card-base p-7 sm:p-12 shadow-xl shadow-brand-ink/5 dark:shadow-black/40 relative overflow-hidden transition-all">
          ...
          <div className="mb-10 relative z-10 text-left">
            <h1 className="text-4xl font-bold text-brand-ink tracking-tight transition-colors leading-tight">Buat Password Baru</h1>
            <p className="text-[11px] font-semibold text-brand-ink/40 mt-3 uppercase tracking-wider transition-colors">Minimal 6 karakter</p>
          </div>
          ...
          <form action={updatePassword} className="space-y-8 relative z-10">
            ...
            <div className="space-y-3 text-left">
              <label htmlFor="reset-password" className="text-[10px] font-semibold text-brand-ink/50 uppercase tracking-normal ml-1">Password Baru</label>
